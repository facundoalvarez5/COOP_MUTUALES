<%@ Page Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Cooperativas.aspx.cs" Inherits="CyM.Cooperativas" %>
        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    ...
                    <div id="divExpedienteEnFormacion" runat="server">
                ...
                <div id="divFooterPantallaABM" runat="server" class="form-actions">
                    <div class="row">
                        <div class="col-md-2">
    ...
    <div id="divPantallaActivarCooperativa" runat="server">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                                                ...
                                                <asp:GridView ID="gvExpedientes" runat="server" CssClass="table table-striped" AutoGenerateColumns="false" DataKeyNames="ID_TRAMITE"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Ver">
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:Button ID="btnVer" runat="server" CommandArgument="<%# Container.DataItemIndex %>"
                                                                    CommandName="VerExpediente" CssClass="botonVer" />
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                ...
                <div id="divFooterPantallaActivarCooperativa" runat="server" class="form-actions">
                    <div class="row">
                        <div class="col-md-2">
