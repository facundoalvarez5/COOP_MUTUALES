<%@ Page  Language="C#"  MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MiSolicitudCurso.aspx.cs" Inherits="CyM.MiSolictudCurso" %>
        ...
        <div class="container">
            ...
            <nav id="nav-menu-container">
                <ul class="nav-menu">
                    ...
                    <li><a href="SolicitudCurso.aspx">Solicitud de Curso</a></li>
                    <li class=" ">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="href="https://cidi.cba.gov.ar/Usuario/Historial">
...
<section id="services">
      <div class="container">
        <div class="section-header">
          <h2>Consulta Mi Solicitud de Curso </h2>
          <p>A continuación se muestran las Solicitudes de Curso para Coopertaiva/Mutual en Formación que usted registró según el Usuario CiDi logueado.</p>
        </div>
		...
		<div class="portlet-body form">
			<!-- BEGIN FORM-->
				...
				<div class="form-actions">
					<div class="row">
						<div class="col-md-2">
                            <asp:Button runat="server" ID="btnVolver" CssClass="btn green form-control" OnClick="btnVolver_OnClick" Text="Volver"/>
						</div>
					</div>
				</div>
			<!-- END FORM-->
				    ...
				    <div class="row">
                        <div class="col-md-4">
                         ...
                         <div class="col-md-4">
                            ...
                            <asp:DropDownList ID="ddlDepartamento" AutoPostBack="True" OnSelectedIndexChanged="ddlDepartamento_OnSelectedIndexChanged" CssClass="form-control dllControl" runat="server" />
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                 ...
                 <div class="row">
                        <div class="col-md-12" style="overflow:scroll;">
                            ...
                            <Columns> 
                                ...
                                <asp:BoundField DataField="TelCelularCodArea" HeaderText="TelCelularCodArea Registro" />
                                <asp:BoundField DataField="TelCelular" HeaderText="TelCelular" />
                                <asp:BoundField DataField="TelFijoCodArea" HeaderText="TelFijoCodArea" />
                                <asp:BoundField DataField="TelFijo" HeaderText="TelFijo" />
